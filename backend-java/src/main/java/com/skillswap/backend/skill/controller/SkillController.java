...
public class SkillController {
    ...
    @PostMapping("/add")
    public Map<String, String> addSkill(@AuthenticationPrincipal CustomUserDetails principal,
    ...
    @GetMapping("/get")
    public List<UserSkillResponse> getSkills(@AuthenticationPrincipal CustomUserDetails principal,
    ...
    @PutMapping("/{id}")
    public Map<String, Object> updateSkill(@AuthenticationPrincipal CustomUserDetails principal,
    ...
    @DeleteMapping("/{id}")
    public Map<String, String> deleteSkill(@AuthenticationPrincipal CustomUserDetails principal,
                                            @PathVariable Long id) {
