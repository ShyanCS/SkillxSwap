...
public record DashboardResponse(
        Stats stats, List<SessionResponse> upcomingSessions, List<ActivityItem> recentActivity) {

    public record Stats(
            long activeMatches, long completedSessions, int creditBalance, long skillsOffered, long skillsRequested) {}
     ...
     */
    public record ActivityItem(Long id, String type, String title, String body, OffsetDateTime createdAt) {}
}
